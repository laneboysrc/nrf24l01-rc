...
;
 ifdef USE_INT_CLOCK
        ...
        __config _CONFIG1, _FCMEN_OFF & _IESO_OFF & _CLKOUTEN_OFF & _BOREN_NSLEEP & _CPD_OFF & _CP_OFF & _MCLRE_ON & _PWRTE_ON & _WDTE_NSLEEP & _FOSC_INTOSC

 else

        __config _CONFIG1, _FCMEN_OFF & _IESO_OFF & _CLKOUTEN_OFF & _BOREN_NSLEEP & _CPD_OFF & _CP_OFF & _MCLRE_ON & _PWRTE_ON & _WDTE_NSLEEP & _FOSC_HS
